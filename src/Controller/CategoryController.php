...
class CategoryController extends AbstractController
{
    ...
    public function viewCategory( $id, ManagerRegistry $doctrine, CartManager $cartManager): Response
    {
        ...
        $selectedCategory = $category_id->getRepository(Category::class)->findAll();
        $products = $categories->getProducts();
        $cart = $cartManager->getCurrentCart();


        return $this->render('category/view.html.twig',['products' => $products,'categories'=>$categories, 'cart' => $cart, 'selectedCategory' => $selectedCategory,]);
    }
    ...
    public function detailsCategory(ManagerRegistry $doctrine, CartManager $cartManager): Response
    {
        ...
        return $this->render('category/details.html.twig', [
            'products' => $products, 'categories'=>$categories, 'cart' => $cart, 'category' => $category,
        ]);
    }
